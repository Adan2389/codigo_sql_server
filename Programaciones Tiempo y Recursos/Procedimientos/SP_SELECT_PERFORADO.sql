...
alter PROCEDURE SELECT_PERFORADO (@ProgramacionID varchar(50))
...
BEGIN
	...
	CREATE TABLE ##Temp_Programacion_Perforado   (
		Item smallint,
	...
	INSERT INTO ##Temp_Programacion_Perforado
		EXECUTE SELECT_PROGRAMACION @ProgramacionID
				...
				FROM ##Temp_Programacion_Perforado as a

	DROP TABLE  ##Temp_Programacion_Perforado
